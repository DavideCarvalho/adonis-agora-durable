...
- [#202](https://github.com/DavideCarvalho/adonis-agora-durable/pull/202) [`573a198`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/573a198ae5e1e69503f3a37d3b9817da07b038c4) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - A run is no longer counted, dead-lettered or executed twice when its turn settles while the orphan sweep is looking at it.
  ...
  - **`recoverIncomplete` decides on the run it locked, not the one it listed.** It trusted the listed `running` status: a run that settled between the listing and `tryLockRun` got a recovery attempt counted and, past `maxRecoveryAttempts`, an unconditional `dead` written over a completed or suspended run. It now re-reads the run under the lease and releases it again unless it still reads `running`. The dead-letter write is also conditional on `running`, so a lease-free `cancel()` landing after that re-read is not overwritten with `dead`.
...
- [#198](https://github.com/DavideCarvalho/adonis-agora-durable/pull/198) [`2b74239`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/2b74239efc6defb62d7f978d8df060384791447a) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Re-drive a `gather_calls` step whose worker was killed mid-step, instead of orphaning it forever.
...
- [`b62ce42`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/b62ce428e6262cf78f55ac96ef1433a3197c1878) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Require cron-parser 5
...
- [#168](https://github.com/DavideCarvalho/adonis-agora-durable/pull/168) [`eb7e642`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/eb7e642f0e956b00b0c177d34f30cb5747389f49) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - A failing lease release no longer escapes the turn's `finally`.
...
- [#123](https://github.com/DavideCarvalho/adonis-agora-durable/pull/123) [`a051483`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/a0514831ffeabb0ba8ba713a22f4d263dedcb542) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Security wave for the console and the multi-tenant trust boundary.
...
- [#100](https://github.com/DavideCarvalho/adonis-agora-durable/pull/100) [`b2297e2`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/b2297e2d5f567ab5b0b3d707457c68d6c596a668) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - `node ace configure` now writes the `#workflows/*` and `#steps/*` subpath imports into the app's `package.json`.
...
- [#95](https://github.com/DavideCarvalho/adonis-agora-durable/pull/95) [`cef9b99`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/cef9b99d1a784828d002537b672e7a92219e24eb) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Add an embedded worker loop: `worker: { embedded: true }` in `config/durable.ts` runs the same loop `durable:work` drives inside the web process, so an app whose only background work is a cadence ships one image and one process instead of a second idle container.
...
- [#93](https://github.com/DavideCarvalho/adonis-agora-durable/pull/93) [`2b42ba5`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/2b42ba5ed58b29744bc71b24a6c6dc04a38d7f77) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - O tick do agendador para de perguntar ao banco o que já sabe.
...
- [#91](https://github.com/DavideCarvalho/adonis-agora-durable/pull/91) [`5c3100c`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/5c3100c4e6101bd87f8180a95ef0ea31c49b3201) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - A extensão do telescope agora contribui os `@Scheduled` descobertos para a tela Live
  Schedules.
...
- [#88](https://github.com/DavideCarvalho/adonis-agora-durable/pull/88) [`8873c6b`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/8873c6b9f0a8c6a90af046368b8aa6309a2c7ad6) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Dashboard: a refused page navigation now gets a real page instead of `{"error":"forbidden"}`.
  ...
  New `accessDenied` option on `config/durable_dashboard.ts` to customise it — an object
...
- [#82](https://github.com/DavideCarvalho/adonis-agora-durable/pull/82) [`fd47f0f`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/fd47f0f042f92872c5bf928efe8aaaedd3c2a604) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - `cron-parser` v5 works, and the Redis-side peers accept their new majors
...
- [#74](https://github.com/DavideCarvalho/adonis-agora-durable/pull/74) [`7cde22b`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/7cde22b05ab0c67c3a6220e09e74bccecc898849) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - An engine with no `namespace` now drives every namespace, instead of only `'default'`.
...
- [#72](https://github.com/DavideCarvalho/adonis-agora-durable/pull/72) [`fcd35eb`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/fcd35eb02fbc0d66e7140f5c1375d7e51e3b3503) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Restore the stub doc comments that `0.24.2` flattened.
...
- [#70](https://github.com/DavideCarvalho/adonis-agora-durable/pull/70) [`c3cadf2`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/c3cadf2f0d24ec8b8f63509688b92cfd680c358e) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Fix `node ace configure @adonis-agora/durable` aborting without writing any files.
...
- [#66](https://github.com/DavideCarvalho/adonis-agora-durable/pull/66) [`1049422`](https://github.com/DavideCarvalho/adonis-agora-durable/commit/104942213fc2aadf61e2e7c8199e56cbbaa735b7) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Remove the `<23` upper bound from `engines.node`.
...
- [`1aace98`](https://github.com/DavideCarvalho/adonis-durable/commit/1aace980b3294c52090e7affe0233917cf0aa118) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Fix `MockAdapter` missing `renewJobs`, added to `@adonisjs/queue`'s `Adapter` interface
